...
for clean in cleans:
    ...
    for telescope in telescopes:
        ...
        for source in range(len(ras)):
            ...
            from simulate_signal import get_delays
            ...
            mean_delays=get_delays(reference_station=chime,feed_positions=feed_positions,ctime=ctime,ra=ra_src,dec=dec_src)
